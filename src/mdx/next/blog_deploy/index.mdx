...
<img src="/images/next/blog_deploy/1.png" width="856px" />

<img src="/images/next/blog_deploy/2.png" width="856px" />
...
<img src="/images/next/blog_deploy/3.png" width="856px" />
...
<img src="/images/next/blog_deploy/4.png" width="856px" />

<img src="/images/next/blog_deploy/5.png" width="856px" />

- 도매인 구매를 완료했으면 AWS Route53에서 호스팅영역을 생성해줍니다. 생성 후 레코드를 살펴보면 네임서버가 생성이 되어있습니다.

<img src="/images/next/blog_deploy/6.png" width="856px" />
...
<img src="/images/next/blog_deploy/7.png" width="856px" />

<img src="/images/next/blog_deploy/8.png" width="856px" />
...
<img src="/images/next/blog_deploy/9.png" width="856px" />
...
<img src="/images/next/blog_deploy/10.png" width="856px" />

- 웹 정적 배포용으로 사용할 S3니까 퍼블릭 엑세스를 해제해줬습니다. 나머지는 기본설정으로 생성!

### AWS CloudFront

<img src="/images/next/blog_deploy/11.png" width="856px" />

<img src="/images/next/blog_deploy/12.png" width="856px" />

- CDN 서비스 이용과 대체도메인 등록을 위한 CloudFront도 생성해줍니다.

<img src="/images/next/blog_deploy/13.png" width="856px" />

- WAF는 사용하지 않았습니다.

<img src="/images/next/blog_deploy/14.png" width="856px" />
...
<img src="/images/next/blog_deploy/15.png" width="856px" />

<img src="/images/next/blog_deploy/16.png" width="856px" />
...
<img src="/images/next/blog_deploy/18.png" width="856px" />
...
<img src="/images/next/blog_deploy/19.png" width="856px" />

<img src="/images/next/blog_deploy/20.png" width="856px" />
