...
<img src="/images/next/lighthouse/1.png" width="100%" />
<img src="/images/next/lighthouse/2.png" width="100%" />
<img src="/images/next/lighthouse/3.png" width="100%" />

접근성 부분을 제외하고 썩 나쁘지않아보입니다. LCP 부분이 위험해보이듯이 빨간색이지만 공식홈페이지에 2.5초면 녹색(빠름)이라 되어있는데 왜 그런지는 모르겠네요.. 🤔

<img src="/images/next/lighthouse/4.png" width="100%" />

제 블로그는 3가지 문제가 나왔는데요. 순서대로 보자면 LCP 속도, image format 최적화, 정적 리소스 캐시가 문제인거 같습니다.

### Largest Contentful Paint element (LCP)

<img src="/images/next/lighthouse/5.png" width="100%" />
...
<img src="/images/next/lighthouse/6.png" width="100%" />

<center>
⬇️
</center>

<img src="/images/next/lighthouse/7.png" width="100%" />
...
<img src="/images/next/lighthouse/10.png" width="100%" />
<img src="/images/next/lighthouse/11.png" width="20%" />
...
<img src="/images/next/lighthouse/12.png" width="100%" />

<center>
⬇️
</center>

<img src="/images/next/lighthouse/13.png" width="100%" />
...
<img src="/images/next/lighthouse/18.png" width="100%" />
<img src="/images/next/lighthouse/19.png" width="100%" />
