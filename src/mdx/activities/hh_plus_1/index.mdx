---
title: "항해플러스 1주차 - 바닐라 JavaScript로 SPA 만들기"
createdAt: 2025-07-13
description: 바닐라 자바스크립트 SPA 만들기 첫번째
...
사전 지식 없이 떠오르는 대로 코드를 만들어가다 보니 리렌더링을 일으키는 Update 부분이 일관적이지 못해 많은 리렌더링이 일어났고 점점 코드가 추가 될수록 어디서 문제가 생긴지 잡아낼 수 없어 더욱 꼬여 건드릴 수 없는 코드가 되었다..⭐️
